...
Using sequences collected by BLAST search, ORTHOSCOPE estimates the gene tree, compares it with the species tree, and identifies a orthogroup. If you have problems, please send me an email. I need to to fix the current version of ORTHOSCOPE (27 Nov 2019).</td>
  </tr>
  <tbody>
    <tr>
