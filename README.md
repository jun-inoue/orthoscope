...
To estimate 2nd gene trees, orthogroup members and outgroups should be selected from the NJ or rearranged NJ tree. Subsequently, selected sequences is re-aligned and subjected to codon-partitioned ML analysis. The downloaded pipeline conduct this procedure automatically.
