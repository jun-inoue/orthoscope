...
ORTHOSCOPE ([Inoue and Satoh 2019](https://academic.oup.com/mbe/article/36/3/621/5229933)) is a web tool to identify orthogroup members (orthologs and paralogs; see below) of a specific protein‑coding gene of animals and plants.  
By uploading gene sequences of interest and selecting species genomes from more than 600 animals and plants, users can infer their functions and copy numbers according to results reported by ORTHOSCOPE in the form of gene trees.

By using sequences collected by BLAST search, ORTHOSCOPE estimates the gene tree, compares it with the [species tree](https://github.com/jun-inoue/Species_tree), and identifies an orthogroup.

ORTHOSCOPE works only for a specific gene and does not allow genome‑scale analyses.  
Recently, a downloadable version, [ORTHOSCOPE\* (STAR)](https://github.com/jun-inoue/ORTHOSCOPE_STAR), was developed. This analytic pipeline accommodates genome‑wide protein‑coding gene data and infers genome‑scale events.

---

![Abstract figure](images/abstract_fig3.jpg)
...
## Quick Start   
![QuickStart](images/quickStart.jpg)
