...
In this paper, maximum likelihood trees were estimated according to the process in "Tree Estimation of Orthogroup Members with Additional Sequences". See below.   
